...
use App\Ark\Mobile\Http\MobileRepairOrderSquareDepositInitiateController;
use App\Ark\Mobile\Http\MobileRepairOrderSquarePaymentCancelController;
use App\Ark\Mobile\Http\MobileRepairOrderSquarePaymentInitiateController;
use App\Ark\Mobile\Http\MobileRepairOrderSquarePaymentPollController;
...
Route::prefix('mobile')->name('api.mobile.')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', EnsureApiStaffActive::class])->group(function (): void {
        ...
        Route::post('/repair-orders/{repairOrder}/square-payments', MobileRepairOrderSquarePaymentInitiateController::class)
            ->name('repair-orders.square-payments.store');
        Route::get('/repair-orders/{repairOrder}/square-payments/{attempt}', MobileRepairOrderSquarePaymentPollController::class)
            ->name('repair-orders.square-payments.show');
        Route::delete('/repair-orders/{repairOrder}/square-payments/{attempt}', MobileRepairOrderSquarePaymentCancelController::class)
            ->name('repair-orders.square-payments.destroy');
        ...
        Route::post('/repair-orders/{repairOrder}/square-deposits', MobileRepairOrderSquareDepositInitiateController::class)
            ->name('repair-orders.square-deposits.store');
