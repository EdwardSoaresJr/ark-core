...
use App\Ark\Operations\Payments\RepairOrderSquarePaymentKeyedCompleteController;
use App\Ark\Operations\Payments\RepairOrderSquarePaymentPollController;
use App\Ark\Operations\Payments\SquareWebhookController;
...
SurfaceRouting::appRoutes(function (): void {
    ...
    Route::middleware(['auth', 'permission:'.StaffFrontDoor::STAFF_SHELL_PERMISSION])->group(function () {
        ...
        Route::post('/app/repair-orders/{repairOrder}/square-deposits', RepairOrderSquareDepositInitiateController::class)
            ->middleware('permission:'.ArkCapability::RepairOrdersCloseout->value)
            ->name('operations.repair-orders.square-deposits.store');

        Route::post('/app/repair-orders/{repairOrder}/square-payments', RepairOrderSquarePaymentInitiateController::class)
            ->middleware('permission:'.ArkCapability::RepairOrdersCloseout->value)
            ->name('operations.repair-orders.square-payments.store');

        Route::post('/app/repair-orders/{repairOrder}/square-payments/{attempt}/complete', RepairOrderSquarePaymentKeyedCompleteController::class)
            ->middleware('permission:'.ArkCapability::RepairOrdersCloseout->value)
            ->name('operations.repair-orders.square-payments.complete');

        Route::get('/app/repair-orders/{repairOrder}/square-payments/{attempt}', RepairOrderSquarePaymentPollController::class)
            ->middleware('permission:'.ArkCapability::RepairOrdersCloseout->value)
            ->name('operations.repair-orders.square-payments.show');

        Route::delete('/app/repair-orders/{repairOrder}/square-payments/{attempt}', RepairOrderSquarePaymentCancelController::class)
            ->middleware('permission:'.ArkCapability::RepairOrdersCloseout->value)
            ->name('operations.repair-orders.square-payments.destroy');
