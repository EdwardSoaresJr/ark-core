...
- Top banner when no network · dismiss not allowed while offline
- Cached read OK · writes queue or block with copy
...
| Surface | Copy tone |
|---------|-----------|
| Communications caught up | "You're caught up." |
| My Work empty | "No assigned work." |
...
- [ ] Failures feel operational · not broken SaaS
- [ ] Ready for Flutter
