...
1. **Growth foundation schema recovery** - [foundation-schema-recovery-v1.md](foundation-schema-recovery-v1.md). Production is missing most `growth_*` tables while migrations are marked Ran. Investigate before any DDL.
2. **Phase 2:** Customer Growth Timeline (Customer Hub / RO context)
3. Public Blade → `SeoEngine` cutover
4. Google Search Console / GA4 sync when credentials exist
