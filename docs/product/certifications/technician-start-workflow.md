...
| Internal note | Advisor sees on desktop without re-entry | ⬜ | |
| Desktop never required | Full chain on phone | ⬜ | |

**Design gate:** What can Landon finish while standing next to the vehicle?
