...
| --- | --- | --- |
| Five workflow videos recorded | ⬜ | Internal ~5 min each |
| Cross-station day video | ⬜ | Counter → lot → bay → office |
| No "did that save?" moments | ⬜ | Operator journal |
| Desktop reflects floor truth | ⬜ | Open office after lot/bay work |

**Explicitly not required on phone:** deep estimate line editing, P&L reporting, shop settings, payroll, long-form email campaigns.

---

## Desktop catches up to phone

When operator opens desktop after phone-first work, authority should already reflect:

- Customer arrived and checked in
- VIN scanned, vehicle verified
- Concern and photos captured
- Technician assigned
- Inspection progress and findings
...
- Do not pursue Desktop Lite feature parity.
