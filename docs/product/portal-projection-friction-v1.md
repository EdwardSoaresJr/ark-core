...
## Carried findings (Phase 4)

### 1. Active visit status ≠ shop production progress
...
**Do not:** Soften numbers in copy to hide the gap.

**Later (if earned):** Stronger deposit / balance / remaining projection on estimate and pay surfaces.

---

### 3. Inspection cannot invent “why it matters”

**Pressure:** Customers want to know why a finding matters for safety or cost.

**Truth today:** If authority has no customer-facing explanation or notes, the Portal must not invent one.
...
### 4. PDF staff-intent taxonomy remains frozen

**Pressure:** Staff recommendation intent labels (`RecommendationIntent::customerLabel`, `CustomerFacingEstimateStatus`) may not match how customers talk about lines.

**Truth today:** Taxonomy is intentional staff → customer mapping; frozen for this rewrite.
