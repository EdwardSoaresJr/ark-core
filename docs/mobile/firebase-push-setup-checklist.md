...
./infra/scripts/firebase-mobile-push-setup.sh \
  ...
  --service-account ~/Downloads/lugsnplugs-ark-mobile-firebase-adminsdk-xxxxx.json \
...
**Settings UI (alternative to script):** [Settings → Communications → Mobile](https://lugsnplugs.arksms.com/app/settings/shop?section=communications&communications-tab=mobile)
