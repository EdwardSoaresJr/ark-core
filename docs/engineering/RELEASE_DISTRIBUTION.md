...
Reporting-only Demo is live: [DEMO_REPORTING_RELEASE.md](DEMO_REPORTING_RELEASE.md). Fleet deploy stays disabled. Do not recreate Demo or redeploy Platform from a stale pending note.
