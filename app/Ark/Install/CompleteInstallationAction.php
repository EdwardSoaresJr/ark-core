...
final class CompleteInstallationAction
{
    ...
    public function execute(array $input): array
    {
        ...
        try {
            ...
            if (! $test['ok']) {
                InstallationState::markFailed('database_test');
            ...
            if (! $safety['ok']) {
                InstallationState::markFailed('database_safety');
            ...
            if ($migrate !== 0) {
                InstallationState::markFailed('migrate');

                return ['ok' => false, 'message' => 'Database migration failed. Check server logs.', 'checkpoint' => 'migrate'];
            }
            ...
            InstallationState::markFailed('exception');
