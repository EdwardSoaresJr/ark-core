...
{
    /**
     * Shop review destination — exclusively from Public Surface settings.
     * Do not hard-code URLs in Blade, JS, or send actions.
     */
    public static function reviewUrl(): string
    {
        return (string) PublicSurfaceSettings::current()['google_reviews_url'];
    }
    ...
    {
        return PublicMarketingUrl::absolute('/contact');
    }
