...
class CustomerShowController
{
    public function __invoke(
        ...
        OperationalJourneyProjection $journeyProjection,
        ...
        $journeyRepairOrder = $customer->repairOrders
            ->first(fn ($repairOrder) => $repairOrder->growth_session_id !== null)
            ?? $customer->repairOrders->first();

        $operationalJourney = $journeyRepairOrder !== null
            ? $journeyProjection->forRepairOrder($journeyRepairOrder)
            : null;
        ...
        return view('operations.customers.show', [
            ...
            'journeyComparison' => ($operationalJourney !== null && $operationalJourney->hasStory)
                ? $journeyComparison->forJourney($operationalJourney)
                : null,
            'operationalJourneyRepairOrder' => $journeyRepairOrder,
