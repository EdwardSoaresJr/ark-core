...
final class LearnArkAdvisorArticles
{
    ...
    public static function all(): array
    {
        return [
            ...
            [
                'slug' => 'square-terminal-floor',
                'title' => 'Square Terminal on the RO',
                'summary' => 'Initiate terminal capture, poll status, keyed fallback.',
                'view' => 'operations.learn.advisor.square-terminal-floor',
            ],
            [
