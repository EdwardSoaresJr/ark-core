...
final class LearnArkOwnerArticles
{
    ...
    public static function all(): array
    {
        return [
            ...
            [
                'slug' => 'square-payments-setup',
                'title' => 'Square payments setup',
                'summary' => 'Pairing code, device ID, webhooks, RO terminal capture.',
                'view' => 'operations.learn.owner.square-payments-setup',
            ],
        ];
    }
