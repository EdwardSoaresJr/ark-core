...
class RepairOrderPartsTechQuoteImportController
{
    ...
    public function preview(
        ...
        abort_unless($launcher->usesRemoteCartPreparation(auth()->user()), 422, 'PartsTech quote import requires a PartsTech password on this profile or in shop settings.');
    ...
    public function store(
        ...
        abort_unless($launcher->usesRemoteCartPreparation($request->user()), 422, 'PartsTech quote import requires a PartsTech password on this profile or in shop settings.');
