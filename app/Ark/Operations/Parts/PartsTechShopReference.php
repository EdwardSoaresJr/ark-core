...
final class PartsTechShopReference
{
    ...
    public static function isAssignedCartReference(string $cartReference, RepairOrder $repairOrder): bool
    {
        $cartReference = trim($cartReference);
        ...
        return self::matchesCartReference($cartReference, $repairOrder);
    }
}
