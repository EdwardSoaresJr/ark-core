<section>
    <div class="border-b border-slate-200 pb-2">
        ...
        <p class="mt-0.5 text-xs text-slate-500">
            Optional personal PartsTech seat. ARK prepares carts and pulls quotes with this login — sign into PartsTech in your browser as the same user. Leave blank to use the shop default from Settings → PartsTech.
        </p>
    </div>
