    ...
    >
        ...
        <div class="grid items-start gap-3 lg:grid-cols-[14rem_minmax(0,1fr)]">
            ...
            <div class="min-w-0 border border-slate-300 bg-white">
                <div class="grid gap-px border-b border-slate-300 bg-slate-300 text-sm sm:grid-cols-3 lg:grid-cols-6">
                ...
                <div class="p-4">
                    ...
                    <div x-show="tab === 'catalogs'" x-cloak>
                        @include('profile.partials.update-parts-catalogs-form')
                    </div>
                </div>
            </div>
        </div>
