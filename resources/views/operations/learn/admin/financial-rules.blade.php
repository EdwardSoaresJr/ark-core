<div class="ops-learn-prose">
    ...
    <p>Square credentials, portal pay toggles, Terminal device codes — owner-facing setup in <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'square-payments-setup']) }}">Square payments setup</a>.</p>
    <p>Advisor floor capture: <a href="{{ route('operations.learn.show', ['role' => 'advisor', 'article' => 'square-terminal-floor']) }}">Square Terminal on the floor</a>.</p>
</div>
