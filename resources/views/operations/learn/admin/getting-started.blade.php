<div class="ops-learn-prose">
    ...
    <ul>
        ...
        <li><strong>Payments</strong> — Square card capture. See <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'square-payments-setup']) }}">Square payments setup</a>.</li>
