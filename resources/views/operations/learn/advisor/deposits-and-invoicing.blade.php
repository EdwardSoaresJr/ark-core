<div class="ops-learn-prose">
    ...
    <p>When Square portal pay is enabled, customers may pay an optional <strong>estimate deposit</strong> immediately after portal authorization — separate from invoice payment links at pickup.</p>
    <p>Counter deposits use the financial rail on the RO; portal deposits flow through the same Square webhook authority as invoice pay links.</p>
    ...
    <p>Partial payments and balance due flow through payment update on the RO; Square captures link separately — see Square guides below.</p>
    ...
    <p>Square Terminal for card-present at the counter — <a href="{{ route('operations.learn.show', ['role' => 'advisor', 'article' => 'square-terminal-floor']) }}">Square Terminal on the floor</a>.</p>
