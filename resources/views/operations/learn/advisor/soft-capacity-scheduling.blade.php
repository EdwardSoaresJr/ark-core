<div class="ops-learn-prose">
    ...
    <h3>Capacity rail</h3>
    <p>
        The Capacity rail shows scheduled work vs base capacity and the shop’s scheduling target
        (which may be above 100%). Warn mode allows booking past the target with a clear notice.
        Block mode stops booking past the target.
    </p>
    ...
    <ul>
        <li>Do not invent a bay just to save the appointment.</li>
        <li>Do not treat Bay or Technician lanes as the only place appointments live.</li>
    </ul>
</div>
