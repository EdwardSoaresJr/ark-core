    ...
    <table class="ops-learn-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong>High urgency.</strong> Usually a stale intake or RO that has not moved in a while.</td>
            </tr>
            <tr>
                <td><strong>Orange dot ●</strong></td>
                <td><strong>Unsaved changes</strong> on that tab. Save or finish editing before closing.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Tab is <strong>kept visible</strong> (pinned). It stays in your tab bar even when you work elsewhere.</td>
            </tr>
        </tbody>
    </table>
