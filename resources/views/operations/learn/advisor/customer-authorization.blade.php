<div class="ops-learn-prose">
    ...
    <p>Collect deposits when shop policy requires before ordering exotic parts — portal deposit after auth when Square portal pay is on; counter deposits on financial rail. See <a href="{{ route('operations.learn.show', ['role' => 'advisor', 'article' => 'deposits-and-invoicing']) }}">Deposits and invoicing</a>.</p>
