<div class="ops-learn-prose">
    ...
    <ol>
        ...
        <li><strong>Labor/parts mix</strong> — Cecil’s balanced model ~55% labor / 45% parts on posted sales.</li>
        <li><strong>Digest schedule</strong> — confirm <code>owner_digest_time</code> and recipients match when you actually bookend.</li>
    </ol>
    ...
    <p>Weekly rhythm: <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'weekly-owner-review']) }}">Weekly owner review</a>. Daily habit: <a href="{{ route('operations.owner.bookend') }}">Bookend</a>.</p>
</div>
