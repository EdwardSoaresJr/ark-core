<div class="ops-learn-prose">
    ...
    <p><a href="{{ route('operations.reports.operational') }}">Operational Report</a> → Executive Pulse for Sales Posted and Cash Collected. Financial tab for reconciliation drill-down. Production tab for bay pressure.</p>
    <p>See <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'ark-reports-guide']) }}">What ARK reports mean</a> and <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'payments-reconciliation']) }}">Payments reconciliation</a>.</p>
</div>
