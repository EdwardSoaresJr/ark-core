<div class="ops-learn-prose">
    ...
    <ol>
        <li>Open <a href="{{ route('operations.index') }}">Home</a> — what needs attention and what is waiting on approval, parts, or customer?</li>
        <li>Open <a href="{{ route('operations.reports.operational') }}">Operational Report</a> for yesterday or rolling 7 days.</li>
        <li>Scan: Sales Posted, Cash Collected, ARO, Effective Labor Rate, Parts Margin, Unpaid Pickups.</li>
    ...
    <h3>Weekly rhythm</h3>
    <ul>
        <li>Financial tab — posted mix, reconciliation for the week, any ROs stuck unposted</li>
        <li>Technician production and efficiency</li>
        <li>Deferred work follow-up plan</li>
    </ul>

    <h3>Monthly</h3>
    <p>Reconcile ARK Sales Posted with your accountant’s P&amp;L. ARK steers operations; P&amp;L owns net profit.</p>

    <p>Margin levers: <a href="{{ route('operations.learn.show', ['role' => 'owner', 'article' => 'shop-margins-five-steps']) }}">Five steps to healthier margins</a>.</p>
</div>
