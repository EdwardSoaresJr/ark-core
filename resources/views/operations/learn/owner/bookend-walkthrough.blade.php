<div class="ops-learn-prose">
    <h3>Bookend closes the day</h3>
    <p><a href="{{ route('operations.owner.bookend') }}">Bookend</a> is the owner’s end-of-day queue review — not a dashboard theater screen. It asks: what is still open, what approvals aged, what is tomorrow’s first move?</p>
    ...
    <p>Bookend complements Operational Report pulse — report is numbers (Sales Posted, Cash Collected, reconciliation); bookend is operational unfinished business.</p>

    <x-operations.learn.figure
        role="owner"
        article="bookend-walkthrough"
        file="bookend-queue.png"
        alt="Bookend end-of-day queue with aging approvals and open work"
        caption="Oldest items are tomorrow’s landmines if ignored tonight."
    />

    <h3>Walkthrough rhythm</h3>
    <p>Scan aging approvals — each is deferred revenue or angry callback. Advisors should have texted; bookend catches what they did not.</p>
    ...
    <p>Active admins can receive a daily digest with Sales Posted, Cash Collected, reconciliation status, queue pressure, and links to Financial tab and Bookend. Schedule and enable in <strong>Settings → Owner Targets &amp; Reporting</strong>. The email is a backup nudge — bookend in ARK is still the authoritative close.</p>
    ...
    <x-operations.learn.video
        ...
        video-key="main"
        title="Five-minute bookend before you leave"
