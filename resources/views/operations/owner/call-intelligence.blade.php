        ...
        <div class="border border-slate-300 bg-white">
            ...
            @unless ($analysisEnabled)
                <div class="border-b border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-950">
                    ...
                    <a href="{{ route('operations.settings.shop.edit', ['section' => 'communications', 'communications-tab' => 'recording']) }}" class="font-bold underline">Settings → Communications → Recording</a>
