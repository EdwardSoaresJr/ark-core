<div class="space-y-3">
    ...
    <div class="overflow-hidden border border-slate-300 bg-white">
        <div class="border-b border-slate-200 bg-slate-50 px-3 py-2">
            ...
            <p class="text-xs text-slate-400">Category dollars are the current approved lines. Margin stays Incomplete data when cost is missing or the lines no longer match the posted invoice.</p>
        </div>
