        ...
        @can(App\Ark\Runtime\Authorization\ArkCapability::GrowthAccess->value)
            @if ($journey->session !== null)
                <div class="border-t border-slate-100 px-3 py-2">
                    <a href="{{ route('growth.sessions.show', $journey->session) }}" class="text-[11px] font-bold text-sky-700 hover:text-sky-900">
                        Open full journey in Growth →
                    </a>
                </div>
            @endif
        @endcan
...
@elseif ($journey !== null && ! $journey->hasStory)
    <div class="border border-dashed border-slate-200 bg-slate-50 px-3 py-2 text-[11px] text-slate-500">
        ...
        <p class="mt-0.5">No Growth session linked yet — the explainable narrative appears when marketing and operations touchpoints connect to this RO.</p>
    </div>
@endif
