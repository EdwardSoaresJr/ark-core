<section x-show="active === 'excellence'" x-cloak>
    <div class="border-b border-slate-200 pb-2">
        ...
        <p class="mt-0.5 text-xs text-slate-500">Three lenses: posted sales truth, Cecil margin KPIs, Lucas owner rhythm. Drives green/amber hints on Operational Report and Margin Health.</p>
    </div>
    ...
    <form method="POST" action="{{ route('operations.settings.shop.excellence.update') }}" class="mt-4 max-w-3xl space-y-4">
        ...
        <div class="border border-slate-200 bg-white px-3 py-3">
            <p class="text-[11px] font-bold uppercase tracking-[0.08em] text-slate-500">Cecil Bullard</p>
            <p class="mt-0.5 text-xs text-slate-500">Margin levers and P&amp;L planning bands — ELR, ARO, parts margin, mix, net profit target.</p>
        ...
        <div class="border border-slate-200 bg-white px-3 py-3">
            <p class="text-[11px] font-bold uppercase tracking-[0.08em] text-slate-500">Lucas Underwood</p>
            <p class="mt-0.5 text-xs text-slate-500">Daily data habit and bookend rhythm — digest timing and quarterly target review.</p>
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('operations.owner.bookend') }}" class="rounded-sm border border-slate-300 px-4 py-2 text-xs font-bold text-slate-800 hover:border-slate-400">Owner Bookend</a>
        </div>
    </form>
</section>
