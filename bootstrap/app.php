...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        $exceptions->dontReport([
            ...
            SquarePaymentRequestException::class,
        ]);
    ...
    ->withSchedule(function (Schedule $schedule): void {
        ...
        $schedule->job(RunGrowthNightlyMaintenanceJob::class)
            ->dailyAt(config('growth.maintenance.nightly_at', '02:00'))
            ->timezone(ShopDisplayTimezone::resolve())
            ->when(fn (): bool => config('growth.enabled', true))
            ->onFailure(function (): void {
                report(new RuntimeException('Scheduled Growth nightly maintenance failed.'));
            })
            ->appendOutputTo(storage_path('logs/scheduler-growth-maintenance.log'));
    })->create();
