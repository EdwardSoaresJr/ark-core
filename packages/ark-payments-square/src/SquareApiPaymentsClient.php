...
final class SquareApiPaymentsClient implements SquarePaymentsClient
{
    ...
    public function createTerminalCheckout(PaymentGatewayAttempt $attempt): SquareTerminalCheckoutResult
    {
        ...
        try {
            $response = $this->client()->terminal->checkouts->create(
    ...
    {
        try {
            $response = $this->client()->terminal->checkouts->get(
    ...
    {
        try {
            $response = $this->client()->terminal->checkouts->cancel(
    ...
    public function createTerminalDeviceCode(?string $name = null): SquareTerminalDeviceCodeResult
    {
        ...
        try {
            $response = $this->client()->devices->codes->create(
    ...
    {
        try {
            $response = $this->client()->devices->codes->get(
    ...
    {
        try {
            $response = $this->client()->payments->get(
    ...
    private function client(): SquareClient
    {
        return new SquareClient(
            ...
            options: [
                'baseUrl' => $this->configuration->isSandbox()
    ...
    private function mapPayment(Payment $payment): SquarePaymentResult
    {
