...
return [
    ...
    */
    ...
    |
    | Production: set SESSION_ENCRYPT=true so session payload is encrypted at rest.
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Ops Shared Session Cookie Domain
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'host_shared_domain' => env('SESSION_DOMAIN'),
    ...
    |
    | Production behind HTTPS: set SESSION_SECURE_COOKIE=true.
    |
    */
