    ...
    */
    ...
    'connections' => [
        ...
        'arksms_legacy' => [
            ...
            'port' => env('ARKSMS_LEGACY_PORT', '3306'),
            'database' => env('ARKSMS_LEGACY_DATABASE', 'arksms'),
            'username' => env('ARKSMS_LEGACY_USERNAME', 'root'),
            'password' => env('ARKSMS_LEGACY_PASSWORD', ''),
            'unix_socket' => env('ARKSMS_LEGACY_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
