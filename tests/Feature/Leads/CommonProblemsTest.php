...
test('common problems index lists curated high-intent problems', function (): void {
    ...
    $this->get(route('public.common-problems.index'))
        ...
        ->assertSee(route('public.common-problems.show', 'brake-repair-colorado-springs'), false)
        ->assertSee(route('public.common-problems.show', 'tune-up-colorado-springs'), false)
        ->assertSee(route('public.common-problems.show', 'auto-repair-colorado-springs'), false)
        ->assertDontSee('Auto repair &amp; services in Colorado Springs', false)
        ...
        ->assertSee('Colorado Springs independent repair', false)
