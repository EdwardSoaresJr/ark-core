...
test('users can authenticate using the login screen', function () {
    ...
    $response->assertRedirect(route('operations.index', absolute: false));
});

test('technicians land on the workboard after login', function () {
    $this->seed(ArkAuthorizationSeeder::class);
    ...
    $this->assertAuthenticated();
    $response->assertRedirect(route('operations.workboard', absolute: false));
});
