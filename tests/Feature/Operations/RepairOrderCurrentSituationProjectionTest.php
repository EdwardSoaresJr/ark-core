...
test('repair order surfaces render sticky current situation from orientation service', function () {
    ...
    $this->actingAs($advisor)
        ...
        ->assertOk()
        ->assertSee('Current Situation', false)
        ->assertSee('Waiting on Diagnosis', false)
        ->assertSee('Progress stopped because', false)
        ->assertSee('Next', false)
        ->assertSee('owner-signal--advisor', false)
